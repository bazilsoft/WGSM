<?php
	...
	namespace app\controllers\SourceQuery;

	use app\controllers\SourceQuery\Exception\InvalidArgumentException;
	use app\controllers\SourceQuery\Exception\InvalidPacketException;
	use app\controllers\SourceQuery\Exception\SocketException;
	 ...
	 * @package SourceQuery
	 *
	 * @uses \SourceQuery\Exception\InvalidArgumentException
