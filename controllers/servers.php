...
//	$servers[1] = ['address' => '185.189.255.19', 'port' =>  29045];
//	$servers[2] = ['address' => '185.189.255.19', 'port' =>  29055];
//	$servers[3] = ['address' => '185.189.255.19', 'port' =>  29065];
//	$servers[4] = ['address' => '185.189.255.19', 'port' =>  29075];
//	$Query = new SourceQuery();
//	foreach ($servers as $k => $server){
////		$Query = new SourceQuery();
//		$serverConnect[$k] = $Query->Connect($server['address'], $server['port'], SQ_TIMEOUT, SQ_ENGINE);
//	}
...
<div class="jumbotron">
	<div class="container">
		...
		<p class="lead">This library was created to query game server which use the Source (Steamworks) query
			protocol.</p>
		...
		<p>
			...
			<a class="btn btn-large btn-danger" href="https://github.com/xPaw/PHP-Source-Query/blob/master/LICENSE">LGPL
				v2.1</a>
		</p>
	</div>
</div>
